    ...
    <div className="space-y-3 rounded-lg border border-line p-4 sm:col-span-2">
      <div>
        ...
        <p className="mt-1 text-xs text-ink/50">
          Además de vender suelto por kg, podés ofrecer formas fijas de
          llevarlo (pieza entera, bolsa de 1kg, trozo, churrasco, etc.). El
          total se calcula solo: precio/kg × peso aprox. × cantidad.
        </p>
      </div>
